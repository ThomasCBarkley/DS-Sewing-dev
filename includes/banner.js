// build magic list of rotating images
	var list = new Array();    var rnd; 
    function list_image(src,alt,href) {     this.src = src;
     this.alt = alt;
     this.href = href;
     return this;    }
    /* this is how to comment out multiple lines
        ...
        */
// truck
    list = list.concat(new list_image("toolbar_images/window/window_chain.gif","Check out our Chains","truck/trucktarp/chain.php"));
    list = list.concat(new list_image("toolbar_images/window/window_cornerprotector.gif","Check out our Corner Protector","truck/trucktarp/winch.php"));
   
    list = list.concat(new list_image("toolbar_images/window/window_leverchainbinders.gif","Check out our Lever Chain Binders","truck/trucktarp/chain.php"));
    list = list.concat(new list_image("toolbar_images/window/window_ratchetchainbinders.gif","Check out our Ratchet Chain Binders","truck/trucktarp/chain.php"));
    ...
    list = list.concat(new list_image("toolbar_images/window/window_tarpbows.gif","Check out our Flexible Tarp Bows","tarpbows/tarpbow2.php"));
    ...
    list = list.concat(new list_image("toolbar_images/window/window_saddlebox.gif","Checkout our Aluminum Saddle Boxes for Trucks","truck_acc/aluminum_boxes/storageboxes.php"));
