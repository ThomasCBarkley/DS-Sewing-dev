...
<form method="post" action="/dan/pid/pidgen">
    @csrf
    <CENTER>
...
<table width=300 border=0 cellpadding=0 cellspacing=0 bgcolor="#ffcc66">
    ...
    <tr><td height=10 colspan=2>&nbsp;</td></tr>
    <tr><td width=30% align=right valign= middle><form method="post" action="/dan/pid/pidgen">Diameter:</td><td align = left valign = middle>@csrf<input name="txtDiameterFt" size="4" maxlength="4"> feet, <input name="txtDiameterIn" size="4" maxlength="4"> inches.<br></td></tr>
    <tr><td align=right valign=middle>Material:</td><td align=left valign=middle>@include('custom_price_generator.parts.material_select')<br></td></tr>
