...
sub estes_rate {
    ...
    my $server_endpoint = "http://services.shipwithcts.com/cts/shiprite/rater.cfm?action=xml&UID=3655&fromzip=23860&tozip=".destination."&shipdate=2020-07-06&weight1=".$weight;
