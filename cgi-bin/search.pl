...
## $dbh = DBI->connect('DBI:mysql:dssewing','dssewing','C4H10o2');


if ($cgih->param('keywords'))
{
...
$SQL = $SQL."GROUP BY site_keywords.ID,filename,title,description ORDER BY sum_weight DESC";
 ...
 open file,"c:\\inetpub\\wwwroot\\ds\\includes\\toolbar.htm";
 print <file>;
 close file; 
 ...
 while ((@row=$sth->fetchrow_array) && $rowcount<20) {
  ...
  print "<TR>";
  print qq{<TD><B>},$rowcount+1,qq{.</B></TD><TD COLSPAN=2><A HREF="/$href"><B>$title</B></A></TD>};
  print "</TR>";
  print "<TR>";
  print qq{<TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>$description</TD>};
...
$SQL = $SQL."GROUP BY site_keywords.ID,filename,title,description ORDER BY sum_weight DESC";
 ...
 while ((@row=$sth->fetchrow_array) && $rowcount<20) {
  ...
  print "<TR>";
  print qq{<TD><B>},$rowcount+1,qq{.</B></TD><TD COLSPAN=2><A HREF="/$href">},$title,"</A></TD>";
  print "</TR>";
  print "<TR>";
##  print qq{<TD>$weight&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>$description</TD>};
  print qq{<TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>$description</TD>};
