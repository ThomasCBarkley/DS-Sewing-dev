<template>
    <div class="pool-wizard-container">
            ...
            <tr>
                <td>
                    <table border="0" bgcolor="#ffcc66" style="BORDER-RIGHT:black 1px solid; BORDER-TOP:black 1px solid; BORDER-LEFT:black 1px solid; BORDER-BOTTOM:black 1px solid" width="100%">
                            ...
                            <td colspan="2" valign="top">
                                <table id="tblCross">
                                    ...
                                    <tr v-for="(item, index) in plotCrossDistance">
                                        <td valign="top">
                                            <input type="text" maxlength="5" size="8" name="CPF" v-model="item.fromindex" />
                                        </td>
                                        <td valign="top">
                                            <input type="text" maxlength="5" size="8" name="CPT" v-model="item.toindex" />
                                        </td>
                                        <td valign="top">
                                            <input type="text" maxlength="5" size="8" name="CPSF" v-model="item.crossdistanceFeet" /> feet
                                        </td>
                                        <td valign="top">
                                            <input type="text" maxlength="5" size="8" name="CPSI" v-model="item.crossdistanceInch" /> inches
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <div v-if="errors">
                            <h3><font color="red">{{errors}}</font></h3>
                        </div>
                        <tr>
...
export default {
    ...
    methods: {
        ...
        showCover: function () {
            this.errors = '';
            this.savePlot();
            axios.get('/s/pool/plot/data-get-cover')
                .then((response) => {
        ...
        finish: function () {
            window.location.href = '/s/pool/finish';
        }
    },
}
</script>