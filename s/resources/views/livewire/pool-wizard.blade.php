        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center text-center">
                ...
                <div class="bg-white custom-container">
                    <div class="post-content text-lg-start post-content-orange">
                        <div class="inner pool-step0">
                                ...
                                <div style="display:{{ $currentStep != 1 ? 'none' : 'block' }}">
                                    <table align="center" width="590">
                                        ...
                                        <tr>
                                            <td>
                                                <table style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid"  border="0">
                                                    <tbody><tr>
                                                        <td align="center"  colspan="2"><b>Welcome to the A/B input form! </b>
                                                        </td>
                                                    </tr>
                                                    <tr>
