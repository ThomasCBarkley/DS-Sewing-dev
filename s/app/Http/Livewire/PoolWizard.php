...
class PoolWizard extends Component
{
	...
	public function submitStep1(Request $request)
	{
        ...
        $this->sendMail($data, $this->txtEmail, "D.S. Sewing Swimming Pool Cover #".$plotId);
        $this->sendMail($data, env('MAIL_MAIN_ADDRESS'), "Plot ID# "
            . $plotId . ' - ' . $this->txtName . ' - ' . $this->txtEmail . ' - ' . $this->txtPhone
        );
    ...
    {
        try {
            Mail::send('emails.pool-wizard-step1', $data, function ($m) use ($to, $subject) {
