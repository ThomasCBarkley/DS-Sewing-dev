...
#End Region
    ...
    Protected WithEvents btnStart1 As Button
    Protected WithEvents rbStart01, rbStart11 As RadioButton
    Protected WithEvents txtPlotID1 As TextBox
    Protected WithEvents rvPlotID1 As RequiredFieldValidator
    Protected WithEvents rngvPlotID1 As RangeValidator
    Protected WithEvents Validationsummary11 As System.Web.UI.WebControls.ValidationSummary
    Protected WithEvents pnlPlotNotFound1 As Panel
