...
<head>
	<?php
	$title       = "D.S. Sewing LEGAL DOCUMENT";
...
<div class="legal-div">
    ...
    <p align="center">
        <FONT FACE="Arial">TERMS OF SALE AGREEMENT</FONT< /P>

        <a>
    <p ALIGN="Center"><A HREF="forms/payment.html" TARGET="><FONT FACE=" Arial">ORDERING, FREIGHT AND PAYMENT
        INFORMATION</FONT</P></a>

    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1"></FONT>
            <FONT SIZE="1">1. EXCEPT AS
                ...
                SUPPLIED UNDER THIS AGREEMENT OR FOR USE BY THE CUSTOMER.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">2. D. S. SEWING, INC. ITS SUCCESSORS AND ASSIGNS SHALL NOT
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">3. TO THE EXTENT PERMITTED BY LAW, D. S. SEWING INC.'S
                TOTAL CUMULATIVE LIABILITY HEREUNDER FOR ANY AND ALL REASONS SHALL NOT EXCEED AN
                AMOUNT EQUAL TO THE PURCHASE PRICE.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">Any legal action arising from or in connection with (A) any
                ...
                to________________________________________.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">4. Any modification of this agreement must be in writing
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">5. D.S. SEWING, INC. and customer each represent that they
                each have the power and authority to enter into this agreement and that the
                agreement constitutes a valid and binding obligation of each party.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">THIS AGREEMENT REPRESENTS THE COMPLETE FINAL AND ENTIRE
                ...
                NEGOTIATIONS BETWEEN THE PARTIES.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">6. Deposits are nonrefundable. In the event the customer is
                ...
                full property of D.S. SEWING, INC.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">7. D.S. SEWING, INC. warrants that it is the owner of the
                goods and that the goods will be free and clear of any lien or encumbrance upon
                delivery to the customer.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">D.S. SEWING, INC's sole and exclusive obligation under this
                ...
                additional material is a result of damage caused by D.S. Sewing, Inc.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">Repair or replacement hereunder shall include cutting
                ...
                improper assembly of sewn pieces to one another.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">D.S. SEWING INC'S. liability hereunder shall not include
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">8. If the customer breaches this agreement, included
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">9. If the performance of any part of this agreement by
                ...
                effect that any such condition shall have on the other party.</FONT>
        </FONT>
    </P>
    ...
    <P>
        <FONT SIZE="+1">
            <FONT SIZE="1">10. All finished product shall have a D. S. Sewing, Inc.
                Label sewn into it unless the customer requests otherwise in writing at the time
                of signing of the contract.</FONT>
        </FONT>
    </P>
    ...
    <CENTER>
        <FONT FACE="Arial" SIZE="2">
            <CENTER>
                ...
                <FONT face=Arial size=-1>1 800 789 8143,&nbsp;1 203 773 1344,&nbsp;FAX 203&nbsp;773
                    1778</FONT>
            </CENTER>
            <CENTER>
                <FONT face=Arial size=2>MAILING ADDRESS:</FONT>
                <FONT face=Arial size=-1> P.O. Box 8983, New Haven, Ct. 06532</FONT>
            </CENTER>
            <CENTER>
                <FONT face=Arial size=2>MANUFACTURING &amp; SALES OFFICE:</FONT>
                <FONT face=Arial size=-1> 260 Wolcott Street,&nbsp;New Haven, CT.
                    06513</FONT><BR>
            </CENTER>
        </FONT>
    </CENTER>

    <p ALIGN="Center"><A HREF="forms/payment.html" TARGET="">
            <FONT FACE="Arial">ORDERING, FREIGHT AND PAYMENT INFORMATION</FONT< /P>
